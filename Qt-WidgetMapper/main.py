...
from PySide6.QtWidgets import QApplication,QLabel, QWidget, QBoxLayout,QVBoxLayout,QTableView,QDialog,QLineEdit, QPushButton,QFormLayout,QDataWidgetMapper
