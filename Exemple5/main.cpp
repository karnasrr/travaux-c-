...
int main()
{
    ...
    const int tailleTabVille = 25;
    VILLE tabVille[tailleTabVille];
    int nbrVille = 0;
...
menu1:
    ...
    case 1:
        ...
        cout <<endl << "AJOUT DE VILLE" <<endl <<endl;

        //saisirVille(nbrVille);
        //nbrVille= ajouterVille(tabVille, nbrVille, saisirVille(nbrVille));
