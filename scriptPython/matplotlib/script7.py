...
# Ajoutons une légende dans le coin supérieur gauche. Cela nécessite seulement l'ajout de l'étiquette d'argument de mot-clé (qui sera utilisée dans la boîte de légende) aux commandes de tracé.
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
# Copyright (c) 2015, Nicolas P. Rougier. All Rights Reserved.
# Distributed under the (new) BSD License. See LICENSE.txt for more info.
